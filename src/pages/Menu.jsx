    ...
    <>
      <Tabs className="tabs-wrapper" id="menu">
        <TabList className="tabs">
          <Tab>
            <button type="button" className="tab-item">Burgers</button>
          </Tab>
          <Tab>
            <button type="button" className="tab-item">Lunch of the day</button>
          </Tab>
          <Tab>
            <button type="button" className="tab-item">Crepes</button>
          </Tab>
        </TabList>
        <TabPanel>
